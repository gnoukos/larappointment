...
@section('content')
    <div class="row">
        <div class="col-md-6 offset-md-3 text-center mt-5">
            ...
            <div class="info-form mt-5 mb-5">
                <form action="{{ url('/datepicker') }}" method="get" id="optionsMenuForm"
                    ...
                    <div id="optionsMenu" class="form-group">
                        ...
                        <select class="form-control" id="level_1_selection"
                                onchange="getNextLevel(value,1,{{ $level1->id }})">
                    ...
                    <button type="submit" class="btn btn-dark" id="chooseDateButton"
                            loading-text="<i class='fa fa-spinner fa-spin '></i> Loading" disabled>Choose Date
                    </button>
                    <div id="invalidInput" class="alert alert-danger alert-dismissible fade show mt-5" role="alert"
                         style="display: none;">
    ...
    <script>
        ...
        function getNextLevel(id, level, levelId) {
            $("#chooseDateButton").button('loading');
            $("#invalidInput").hide();
